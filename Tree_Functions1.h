...
bool Elem_And_Next_OK(elem *element) {
...
bool Tree_OK(tree_header *header) {
...
void Mini_File_Dump(elem * element){
...
void Elem_And_Next_Dump(elem * elm){
    elem * element = elm;
    if (!elm) return;
...
void Tree_Dump(tree_header *header) {
